...
namespace DoAn {
    ...
    public partial class BanGiayDataSet : global::System.Data.DataSet {
        ...
        public partial class NHACUNGCAPDataTable : global::System.Data.TypedTableBase<NHACUNGCAPRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NHACUNGCAPRow AddNHACUNGCAPRow(string TENNCC, string DIACHI, string SDT, int TRANGTHAI, int MANCC) {
...
namespace DoAn.BanGiayDataSetTableAdapters {
    ...
    public partial class NHACUNGCAPTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NHACUNGCAP] WHERE (([TENNCC] = @Original_TENNCC) AND ([DIACHI]" +
                " = @Original_DIACHI) AND ([SDT] = @Original_SDT) AND ([TRANGTHAI] = @Original_TR" +
                "ANGTHAI) AND ([MANCC] = @Original_MANCC))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NHACUNGCAP] ([TENNCC], [DIACHI], [SDT], [TRANGTHAI], [MANCC]) " +
                "VALUES (@TENNCC, @DIACHI, @SDT, @TRANGTHAI, @MANCC);\r\nSELECT TENNCC, DIACHI, SDT" +
                ", TRANGTHAI, MANCC FROM NHACUNGCAP WHERE (MANCC = @MANCC)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NHACUNGCAP] SET [TENNCC] = @TENNCC, [DIACHI] = @DIACHI, [SDT] = @SDT, [TRANGTHAI] = @TRANGTHAI, [MANCC] = @MANCC WHERE (([TENNCC] = @Original_TENNCC) AND ([DIACHI] = @Original_DIACHI) AND ([SDT] = @Original_SDT) AND ([TRANGTHAI] = @Original_TRANGTHAI) AND ([MANCC] = @Original_MANCC));
SELECT TENNCC, DIACHI, SDT, TRANGTHAI, MANCC FROM NHACUNGCAP WHERE (MANCC = @MANCC)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TENNCC, DIACHI, SDT, TRANGTHAI, MANCC FROM dbo.NHACUNGCAP";
        ...
        public virtual int Fill(BanGiayDataSet.NHACUNGCAPDataTable dataTable) {
        ...
        public virtual BanGiayDataSet.NHACUNGCAPDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BanGiayDataSet.NHACUNGCAPDataTable dataTable = new BanGiayDataSet.NHACUNGCAPDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BanGiayDataSet.NHACUNGCAPDataTable dataTable) {
        ...
        public virtual int Delete(string Original_TENNCC, string Original_DIACHI, string Original_SDT, int Original_TRANGTHAI, int Original_MANCC) {
        ...
        public virtual int Insert(string TENNCC, string DIACHI, string SDT, int TRANGTHAI, int MANCC) {
            if ((TENNCC == null)) {
        ...
        public virtual int Update(string TENNCC, string DIACHI, string SDT, int TRANGTHAI, int MANCC, string Original_TENNCC, string Original_DIACHI, string Original_SDT, int Original_TRANGTHAI, int Original_MANCC) {
            if ((TENNCC == null)) {
                throw new global::System.ArgumentNullException("TENNCC");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TENNCC, string DIACHI, string SDT, int TRANGTHAI, string Original_TENNCC, string Original_DIACHI, string Original_SDT, int Original_TRANGTHAI, int Original_MANCC) {
            return this.Update(TENNCC, DIACHI, SDT, TRANGTHAI, Original_MANCC, Original_TENNCC, Original_DIACHI, Original_SDT, Original_TRANGTHAI, Original_MANCC);
        }
    }
